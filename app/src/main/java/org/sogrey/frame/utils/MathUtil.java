...
public class MathUtil {
    ...
    public static BigDecimal round(double number,int decimal) {
        return new BigDecimal(number).setScale(
                decimal,
     ...
     * @return
     */
    public static boolean pointAtSLine(
            double x,double y,double x1,
     ...
     * @return
     */
    public static boolean LineAtLine(
     ...
     * @return
     */
    public static boolean eLineAtELine(
            double x1,double y1,double x2,
            double y2,double x3,double y3,double x4,double y4
    ) {
        double k1=(y2-y1)/(x2-x1);
     ...
     * @return
     */
    public static boolean eLineAtLine(
            double x1,double y1,double x2,
            double y2,double x3,double y3,double x4,double y4
    ) {
        double k1=(y2-y1)/(x2-x1);
     ...
     * @return
     */
    public static boolean pointAtRect(
     ...
     * @return
     */
    public static boolean rectAtRect(
            double x1,double y1,double x2,
            double y2,double x3,double y3,double x4,double y4
    ) {
     ...
     * @return
     */
    public static boolean circleAtRect(
            double x,double y,double r,double x1,
            double y1,double x2,double y2
    ) {
        // 圆心在矩形内
        if (x>=Math.min(x1,x2)&&x<=Math.max(x1,x2)
     ...
     * @return 是否碰撞
     */
    public static boolean isRectCollision(
