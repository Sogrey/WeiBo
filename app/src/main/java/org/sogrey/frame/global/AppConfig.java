 ...
 */
package org.sogrey.frame.global;
...
public class AppConfig {
    ...
    public static String SHARED_PATH="app_rbim5d_share";

    /** 默认数据库文件名 */
    public static String DB_NAME   ="RBIM5D.db";
    /** 默认数据库版本 */
    public static int    DB_VERSION=1;

    /** 默认下载文件地址. */
    public static String DOWNLOAD_ROOT_DIR="Android/data";
