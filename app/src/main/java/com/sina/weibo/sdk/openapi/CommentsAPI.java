...
public class CommentsAPI extends AbsOpenAPI {
     ...
     *         异步请求回调接口
     */
    public void show(long id,long since_id,long max_id,int count,int page,int authorType,
     ...
     *         异步请求回调接口
     */
    public void byME(long since_id,long max_id,int count,int page,int sourceType,RequestListener
            listener) {
        WeiboParameters params=buildTimeLineParamsBase(since_id,max_id,count,page);
     ...
     */
    public void reply(
            long cid,long id,String comment,boolean without_mention,boolean comment_ori,
            RequestListener listener
    ) {
     ...
     */
    public String toMESync(long since_id,long max_id,int count,int page,int authorType,int
            sourceType) {
        WeiboParameters params=buildTimeLineParamsBase(since_id,max_id,count,page);
        params.put("filter_by_author",authorType);
        params.put("filter_by_source",sourceType);
     ...
     */
    public String mentionsSync(long since_id,long max_id,int count,int page,int authorType,int
            sourceType) {
        WeiboParameters params=buildTimeLineParamsBase(since_id,max_id,count,page);
        params.put("filter_by_author",authorType);
        params.put("filter_by_source",sourceType);
     ...
     */
    public String replySync(long cid,long id,String comment,boolean without_mention,boolean
            comment_ori) {
        WeiboParameters params=buildReplyParams(cid,id,comment,without_mention,comment_ori);
    ...
    private WeiboParameters buildReplyParams(
            long cid,long id,String comment,boolean without_mention,
            boolean comment_ori
    ) {
        WeiboParameters params=new WeiboParameters(mAppKey);
        params.put("cid",cid);
