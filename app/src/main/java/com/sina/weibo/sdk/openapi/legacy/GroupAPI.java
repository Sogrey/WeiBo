...
public class GroupAPI extends AbsOpenAPI {
    ...
    public void timeline(
            long list_id,long since_id,long max_id,int count,int page,boolean base_app,
     ...
     *         异步请求回调接口
     */
    public void update(long list_id,String name,String description,String tags,RequestListener
            listener) {
        WeiboParameters params=new WeiboParameters(mAppKey);
        params.put("list_id",list_id);
     ...
     *         添加成员的分组说明，每个说明最多8个汉字，16个半角字符，多个需先URLencode，然后再用半角逗号分隔，最多不超过30个，且需与uids参数一一对应
     * @param listener
     *         异步请求回调接口
     */
    public void addMemberBatch(long list_id,String uids,String group_descriptions,RequestListener
            listener) {
     ...
     *         异步请求回调接口
     */
    public void updateMembers(long list_id,long uid,String group_description,RequestListener
            listener) {
        WeiboParameters params=buildeMembersParams(list_id,uid);
