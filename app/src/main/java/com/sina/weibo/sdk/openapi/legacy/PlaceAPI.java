...
public class PlaceAPI extends AbsOpenAPI {
    ...
    public void friendsTimeline(
            long since_id,long max_id,int count,int page,boolean only_attentions,
     ...
     *         异步请求回调接口
     */
    public void poiTimeline(
            String poiid,long since_id,long max_id,int count,int page,boolean base_app,
            RequestListener listener
    ) {
        WeiboParameters params=buildTimeLineParamsBase(since_id,max_id,count,page);
     ...
     *         异步请求回调接口
     */
    public void nearbyTimeline(
            String lat,String lon,int range,long starttime,long endtime,int sortType,
     ...
     *         异步请求回调接口
     */
    public void usersCheckins(long uid,int count,int page,boolean base_app,RequestListener
            listener) {
     ...
     *         异步请求回调接口
     */
    public void poisUsers(String poiid,int count,int page,boolean base_app,RequestListener
            listener) {
     ...
     *         异步请求回调接口
     */
    public void poisPhotos(String poiid,int count,int page,int sortType,boolean base_app,
                           RequestListener listener) {
        WeiboParameters params=buildPoisParams(poiid,count,page,base_app);
     ...
     *         异步请求回调接口
     */
    public void poisTips(String poiid,int count,int page,int sortType,boolean base_app,
                         RequestListener listener) {
        WeiboParameters params=buildPoisParams(poiid,count,page,base_app);
        params.put("sort",sortType);
     ...
     *         异步请求回调接口
     */
    public void nearbyPois(
            String lat,String lon,int range,String q,String category,int count,int page,
    ...
    public void nearbyUsers(
            String lat,String lon,int range,long starttime,long endtime,int sortType,int count,
     ...
     * @param sortType
     *         排序方式，0：按时间、1：按距离、2：按社会化关系，默认为2。
    ...
    public void nearbyUserList(
            String lat,String lon,int count,int page,int range,int sortType,int filterType,
     ...
     *         异步请求回调接口
     */
    public void poisCreate(
            String title,String address,String category,String lat,String lon,String city,
    ...
    // 组装UserParams的参数
    private WeiboParameters buildNearbyParams(
            String lat,String lon,int range,int count,int page,
