...
public class ShortUrlAPI extends AbsOpenAPI {
     ...
     *         异步请求回调接口
     */
    public void shareStatuses(
            String url_short,long since_id,long max_id,int count,int page,
    ...
    // 组装URL参数
    private WeiboParameters buildRequestParams(String url_short,long since_id,long max_id,int
            count,int page) {
        WeiboParameters params=new WeiboParameters(mAppKey);
        params.put("url_short",url_short);
