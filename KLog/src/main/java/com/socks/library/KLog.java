 ...
 * <ol>
 * <li>use KLog.d(),you could print whether the method execute,and the default tag is current
 * class's name</li>
 * <li>use KLog.d(msg),you could print log as before,and you could location the method with a click
 * in Android Studio Logcat</li>
